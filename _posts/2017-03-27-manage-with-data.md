...
## 总结
这本书清晰的阐明了数据在零售业的业务追踪、经营指导、策略制定、战略规划中可以发挥的作用。用人货场的思维方式分析销售等业务问题，用进销存的关系理清楚商品的各个方面，用黄氏曲线处理数据使得数据可对比可预测。还系统的讲述了渠道、会员、竞争对手等零售业常见因素的分析方法。可以看出作者在零售业经验丰富，文字功底也很了得。此片笔记留作以后快速查询。
